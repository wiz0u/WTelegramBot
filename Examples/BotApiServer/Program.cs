...
static async Task<object> HandleRequest(WTelegramBotClient bot, string method, string json, CancellationToken ct) => method.ToLowerInvariant() switch
{
	...
	"sendlivephoto" => await bot.SendRequest(Parse<SendLivePhotoRequest>(json), ct),
	...
	"answerchatjoinrequestquery" => await bot.SendRequest(Parse<AnswerChatJoinRequestQueryRequest>(json), ct),
	"sendchatjoinrequestwebapp" => await bot.SendRequest(Parse<SendChatJoinRequestWebAppRequest>(json), ct),
	...
	"getuserpersonalchatmessages" => await bot.SendRequest(Parse<GetUserPersonalChatMessagesRequest>(json), ct),
	...
	"answerguestquery" => await bot.SendRequest(Parse<AnswerGuestQueryRequest>(json), ct),
	...
	"getmanagedbotaccesssettings" => await bot.SendRequest(Parse<GetManagedBotAccessSettingsRequest>(json), ct),
	"setmanagedbotaccesssettings" => await bot.SendRequest(Parse<SetManagedBotAccessSettingsRequest>(json), ct),
	...
	"deletemessagereaction" => await bot.SendRequest(Parse<DeleteMessageReactionRequest>(json), ct),
	"deleteallmessagereactions" => await bot.SendRequest(Parse<DeleteAllMessageReactionsRequest>(json), ct),
	...
	"sendrichmessage" => await bot.SendRequest(Parse<SendRichMessageRequest>(json), ct),
	"sendrichmessagedraft" => await bot.SendRequest(Parse<SendRichMessageDraftRequest>(json), ct),
