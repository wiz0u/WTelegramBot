...
public partial class WTelegramBotClient : ITelegramBotClient
{
	...
	public virtual async Task<TResponse> MakeRequestAsync<TResponse>(IRequest<TResponse> request, CancellationToken cancellationToken)
	{
		return (TResponse)(object)(request switch
		{
			...
			SendPaidMediaRequest r => await SendPaidMedia(r.ChatId, r.StarCount, r.Media, r.Payload, r.Caption, r.ParseMode, r.CaptionEntities, r.ShowCaptionAboveMedia, r.DisableNotification, r.ProtectContent, r.ReplyParameters, r.ReplyMarkup, r.BusinessConnectionId, cancellationToken),
			...
			PinChatMessageRequest r => await PinChatMessageAsync(r.ChatId, r.MessageId, r.DisableNotification, r.BusinessConnectionId, cancellationToken).ReturnTrue(),
			UnpinChatMessageRequest r => await UnpinChatMessageAsync(r.ChatId, r.MessageId, r.BusinessConnectionId, cancellationToken).ReturnTrue(),
