...
public partial class WTelegramBotClient : ITelegramBotClient
{
	...
	public async Task<TResponse> SendRequest<TResponse>(IRequest<TResponse> request, CancellationToken cancellationToken)
	{
		return (TResponse)(object)(request switch
		{
			...
			ForwardMessageRequest r => await ForwardMessage(r.ChatId, r.FromChatId, r.MessageId, r.MessageThreadId, r.DisableNotification, r.ProtectContent, cancellationToken),
			...
			CopyMessageRequest r => await CopyMessage(r.ChatId, r.FromChatId, r.MessageId, r.Caption, r.ParseMode, r.ReplyParameters, r.ReplyMarkup, r.MessageThreadId, r.CaptionEntities, r.ShowCaptionAboveMedia, r.DisableNotification, r.ProtectContent, r.AllowPaidBroadcast, cancellationToken),
			...
			SendGiftRequest r => await SendGift(r.UserId, r.GiftId, r.Text, r.TextParseMode, r.TextEntities, r.PayForUpgrade, cancellationToken).ReturnTrue(),
