...
public partial class WTelegramBotClient : ITelegramBotClient
{
	...
	public async Task<TResponse> SendRequest<TResponse>(IRequest<TResponse> request, CancellationToken cancellationToken)
	{
		return (TResponse)(object)(request switch
		{
			...
			EditMessageTextRequest r => await EditMessageText(r.ChatId, r.MessageId, r.Text, r.ParseMode, r.ReplyMarkup, r.LinkPreviewOptions, r.Entities, r.BusinessConnectionId, cancellationToken),
			EditInlineMessageTextRequest r => await EditMessageText(r.InlineMessageId, r.Text, r.ParseMode, r.ReplyMarkup, r.LinkPreviewOptions, r.Entities, r.BusinessConnectionId, cancellationToken).ReturnTrue(),
