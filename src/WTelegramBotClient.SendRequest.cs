...
public partial class WTelegramBotClient : ITelegramBotClient
{
	...
	public async Task<TResponse> SendRequest<TResponse>(IRequest<TResponse> request, CancellationToken cancellationToken)
	{
		return (TResponse)(object)(request switch
		{
			...
			ForwardMessageRequest r => await ForwardMessage(r.ChatId, r.FromChatId, r.MessageId, r.MessageThreadId, r.DisableNotification, r.ProtectContent, r.VideoStartTimestamp, r.DirectMessagesTopicId, r.SuggestedPostParameters, r.MessageEffectId, cancellationToken),
			...
			SendLivePhotoRequest r => await SendLivePhoto(r.ChatId, r.LivePhoto, r.Photo, r.Caption, r.ParseMode, r.ReplyParameters, r.ReplyMarkup, r.MessageThreadId, r.CaptionEntities, r.ShowCaptionAboveMedia, r.HasSpoiler, r.DisableNotification, r.ProtectContent, r.MessageEffectId, r.BusinessConnectionId, r.AllowPaidBroadcast, r.DirectMessagesTopicId, r.SuggestedPostParameters, cancellationToken),
			...
			SendPaidMediaRequest r => await SendPaidMedia(r.ChatId, r.StarCount, r.Media, r.Caption, r.ParseMode, r.ReplyParameters, r.ReplyMarkup, r.Payload, r.MessageThreadId, r.CaptionEntities, r.ShowCaptionAboveMedia, r.DisableNotification, r.ProtectContent, r.BusinessConnectionId, r.AllowPaidBroadcast, r.DirectMessagesTopicId, r.SuggestedPostParameters, cancellationToken),
			...
			SendPollRequest r => await SendPoll(r.ChatId, r.Question, r.Options, r.IsAnonymous ?? true, r.Type, r.AllowsMultipleAnswers, r.CorrectOptionIds, r.ReplyParameters, r.ReplyMarkup, r.Explanation, r.ExplanationParseMode, r.ExplanationEntities, r.ExplanationMedia, r.QuestionParseMode, r.QuestionEntities, r.Description, r.DescriptionParseMode, r.DescriptionEntities, r.Media, r.OpenPeriod, r.CloseDate, r.IsClosed, r.MessageThreadId, r.DisableNotification, r.ProtectContent, r.MessageEffectId, r.BusinessConnectionId, r.AllowPaidBroadcast, r.AllowsRevoting, r.ShuffleOptions, r.AllowAddingOptions, r.HideResultsUntilCloses, r.MembersOnly, r.CountryCodes, cancellationToken),
			...
			SendMessageDraftRequest r => await SendMessageDraft(r.ChatId, r.DraftId, r.Text, r.ParseMode, r.MessageThreadId, r.Entities, cancellationToken).ReturnTrue(),
			...
			GetUserProfileAudiosRequest r => await GetUserProfileAudios(r.UserId, r.Offset, r.Limit, cancellationToken),
			...
			PromoteChatMemberRequest r => await PromoteChatMember(r.ChatId, r.UserId, r.IsAnonymous, r.CanManageChat, r.CanPostMessages, r.CanEditMessages, r.CanDeleteMessages, r.CanPostStories, r.CanEditStories, r.CanDeleteStories, r.CanManageVideoChats, r.CanRestrictMembers, r.CanPromoteMembers, r.CanChangeInfo, r.CanInviteUsers, r.CanPinMessages, r.CanManageTopics, r.CanManageDirectMessages, r.CanManageTags, cancellationToken).ReturnTrue(),
			...
			SetChatMemberTagRequest r => await SetChatMemberTag(r.ChatId, r.UserId, r.Tag, cancellationToken).ReturnTrue(),
			...
			AnswerChatJoinRequestQueryRequest r => await AnswerChatJoinRequestQuery(r.ChatJoinRequestQueryId, r.Result, cancellationToken).ReturnTrue(),
			SendChatJoinRequestWebAppRequest r => await SendChatJoinRequestWebApp(r.ChatJoinRequestQueryId, r.WebAppUrl, cancellationToken).ReturnTrue(),
			...
			GetChatAdministratorsRequest r => await GetChatAdministrators(r.ChatId, r.ReturnBots, cancellationToken),
			...
			GetUserPersonalChatMessagesRequest r => await GetUserPersonalChatMessages(r.UserId, r.Limit, cancellationToken),
			...
			AnswerGuestQueryRequest r => await AnswerGuestQuery(r.GuestQueryId, r.Result, cancellationToken),
			...
			GetManagedBotTokenRequest r => await GetManagedBotToken(r.UserId, cancellationToken),
			ReplaceManagedBotTokenRequest r => await ReplaceManagedBotToken(r.UserId, cancellationToken),
			GetManagedBotAccessSettingsRequest r => await GetManagedBotAccessSettings(r.UserId, cancellationToken),
			SetManagedBotAccessSettingsRequest r => await SetManagedBotAccessSettings(r.UserId, r.IsAccessRestricted, r.AddedUserIds, cancellationToken).ReturnTrue(),
			...
			SetMyProfilePhotoRequest r => await SetMyProfilePhoto(r.Photo, cancellationToken).ReturnTrue(),
			RemoveMyProfilePhotoRequest => await RemoveMyProfilePhoto(cancellationToken).ReturnTrue(),
			...
			GetBusinessAccountGiftsRequest r => await GetBusinessAccountGifts(r.BusinessConnectionId, r.ExcludeUnsaved, r.ExcludeSaved, r.ExcludeUnlimited, r.ExcludeLimitedUpgradable, r.ExcludeLimitedNonUpgradable, r.ExcludeFromBlockchain, r.ExcludeUnique, r.SortByPrice, r.Offset, r.Limit, cancellationToken),
			GetUserGiftsRequest r => await GetUserGifts(r.UserId, r.ExcludeUnlimited, r.ExcludeLimitedUpgradable, r.ExcludeLimitedNonUpgradable, r.ExcludeFromBlockchain, r.ExcludeUnique, r.SortByPrice, r.Offset, r.Limit, cancellationToken),
			GetChatGiftsRequest r => await GetChatGifts(r.ChatId, r.ExcludeUnsaved, r.ExcludeSaved, r.ExcludeUnlimited, r.ExcludeLimitedUpgradable, r.ExcludeLimitedNonUpgradable, r.ExcludeFromBlockchain, r.ExcludeUnique, r.SortByPrice, r.Offset, r.Limit, cancellationToken),
			...
			RepostStoryRequest r => await RepostStory(r.BusinessConnectionId, r.FromChatId, r.FromStoryId, r.ActivePeriod, r.PostToChatPage, r.ProtectContent, cancellationToken),
			...
			SavePreparedKeyboardButtonRequest r => await SavePreparedKeyboardButton(r.UserId, r.Button, cancellationToken),
			EditMessageTextRequest r => await EditMessageText(r.ChatId, r.MessageId, r.Text, r.ParseMode, r.ReplyMarkup, r.LinkPreviewOptions, r.Entities, r.RichMessage, r.BusinessConnectionId, cancellationToken),
			EditInlineMessageTextRequest r => await EditMessageText(r.InlineMessageId, r.Text, r.ParseMode, r.ReplyMarkup, r.LinkPreviewOptions, r.Entities, r.RichMessage, r.BusinessConnectionId, cancellationToken).ReturnTrue(),
			EditMessageCaptionRequest r => await EditMessageCaption(r.ChatId, r.MessageId, r.Caption, r.ParseMode, r.ReplyMarkup, r.CaptionEntities, r.ShowCaptionAboveMedia, r.BusinessConnectionId, cancellationToken),
			EditInlineMessageCaptionRequest r => await EditMessageCaption(r.InlineMessageId, r.Caption, r.ParseMode, r.ReplyMarkup, r.CaptionEntities, r.ShowCaptionAboveMedia, r.BusinessConnectionId, cancellationToken).ReturnTrue(),
			...
			DeleteMessageReactionRequest r => await DeleteMessageReaction(r.ChatId, r.MessageId, r.UserId, r.ActorChatId, cancellationToken).ReturnTrue(),
			DeleteAllMessageReactionsRequest r => await DeleteAllMessageReactions(r.ChatId, r.UserId, r.ActorChatId, cancellationToken).ReturnTrue(),
			...
			SendRichMessageRequest r => await SendRichMessage(r.ChatId, r.RichMessage, r.ReplyParameters, r.ReplyMarkup, r.MessageThreadId, r.DisableNotification, r.ProtectContent, r.MessageEffectId, r.BusinessConnectionId, r.AllowPaidBroadcast, r.DirectMessagesTopicId, r.SuggestedPostParameters, cancellationToken),
			SendRichMessageDraftRequest r => await SendRichMessageDraft(r.ChatId, r.DraftId, r.RichMessage, r.MessageThreadId, cancellationToken).ReturnTrue(),
