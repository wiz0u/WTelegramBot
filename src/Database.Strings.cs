...
/*LoadSession*/	"SELECT Data, LastUpdateId, AllowedUpdates FROM WTB_Session WHERE Name = 'WTelegramBot'",
/*SaveSession*/	"INSERT INTO WTB_Session (Name, Data, LastUpdateId, AllowedUpdates) VALUES ('WTelegramBot', @Data, @LastUpdateId, @AllowedUpdates) ON CONFLICT (Name) DO UPDATE SET Data = EXCLUDED.Data, LastUpdateId = EXCLUDED.LastUpdateId, AllowedUpdates = EXCLUDED.AllowedUpdates",
/*LoadUpdates*/	"SELECT Id, Raw FROM WTB_Updates ORDER BY Id",
/*DelUpdates*/	"DELETE FROM WTB_Updates",
/*SaveUpdates*/	"INSERT INTO WTB_Updates (Id, Raw) VALUES (@Id, @Raw)",
...
/*DbSetup*/		"CREATE TABLE IF NOT EXISTS WTB_MBoxState (MBox BIGINT NOT NULL PRIMARY KEY, pts INT NOT NULL, access_hash BIGINT NOT NULL) ;\n" +
				...
				"CREATE TABLE IF NOT EXISTS WTB_Chats (Id BIGINT NOT NULL PRIMARY KEY, AccessHash BIGINT NOT NULL, Flags INT NOT NULL, FirstName VARCHAR(255) NOT NULL, LastName VARCHAR(255) NOT NULL, Username VARCHAR(255) NOT NULL, Type INT NOT NULL) ;\n",
/*LoadSession*/	"SELECT Data, LastUpdateId, AllowedUpdates FROM WTB_Session WHERE Name = 'WTelegramBot'",
/*SaveSession*/	"REPLACE INTO WTB_Session (Name, Data, LastUpdateId, AllowedUpdates) VALUES ('WTelegramBot', @Data, @LastUpdateId, @AllowedUpdates)",
/*LoadUpdates*/	"SELECT Id, Raw FROM WTB_Updates ORDER BY Id",
/*DelUpdates*/	"DELETE FROM WTB_Updates",
/*SaveUpdates*/	"INSERT INTO WTB_Updates (Id, Raw) VALUES (@Id, @Raw)",
/*LoadMBox*/	"SELECT MBox, pts, access_hash FROM WTB_MBoxState",
