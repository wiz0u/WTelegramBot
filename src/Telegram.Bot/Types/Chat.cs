...
public partial class Chat
{
    ...
    /// <summary>
    /// <em>Optional</em>. <see langword="true"/>, if the supergroup chat is a forum (has <a href="https://telegram.org/blog/topics-in-groups-collectible-usernames#topics-in-groups">topics</a> enabled)
    /// </summary>
...
public partial class ChatFullInfo : Chat
{
    ...
    /// <summary>
    /// <em>Optional</em>. List of available reactions allowed in the chat. If omitted, then all <see cref="ReactionTypeEmoji">emoji reactions</see> are allowed.
    /// </summary>
    ...
    /// <summary>
    /// <em>Optional</em>. Expiration date of the emoji status of the chat or the other party in a private chat,, if any
    /// </summary>
    ...
    /// <summary>
    /// <em>Optional</em>. <see langword="true"/>, if privacy settings of the other party in the private chat allows to use <c>tg://user?id=&lt;UserId&gt;</c> links only in chats with the user
    /// </summary>
    public bool HasPrivateForwards { get; set; }

    /// <summary>
    /// <em>Optional</em>. <see langword="true"/>, if the privacy settings of the other party restrict sending voice and video note messages in the private chat
    /// </summary>
    public bool HasRestrictedVoiceAndVideoMessages { get; set; }

    /// <summary>
    /// <em>Optional</em>. <see langword="true"/>, if users need to join the supergroup before they can send messages
    /// </summary>
    ...
    /// <summary>
    /// <em>Optional</em>. <see langword="true"/>, if aggressive anti-spam checks are enabled in the supergroup. The field is only available to chat administrators.
    /// </summary>
    public bool HasAggressiveAntiSpamEnabled { get; set; }

    /// <summary>
    /// <em>Optional</em>. <see langword="true"/>, if non-administrators can only get the list of bots and administrators in the chat
    /// </summary>
    public bool HasHiddenMembers { get; set; }

    /// <summary>
    /// <em>Optional</em>. <see langword="true"/>, if messages from the chat can't be forwarded to other chats
    /// </summary>
    public bool HasProtectedContent { get; set; }

    /// <summary>
    /// <em>Optional</em>. <see langword="true"/>, if new chat members will have access to old messages; available only to chat administrators
    /// </summary>
    ...
    /// <summary>
    /// <em>Optional</em>. <see langword="true"/>, if the bot can change the group sticker set
    /// </summary>
    ...
    /// <summary>
    /// <em>Optional</em>. Unique identifier for the linked chat, i.e. the discussion group identifier for a channel and vice versa; for supergroups and channel chats.
    /// </summary>
