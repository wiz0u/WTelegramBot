...
public partial class InputTextMessageContent : InputMessageContent
{
    ...
    /// <summary>
    /// Initializes an instance of <see cref="InputTextMessageContent"/>
    /// </summary>
    ...
    /// <summary>
    /// Instantiates a new <see cref="InputTextMessageContent"/>
    /// </summary>
...
public partial class InputLocationMessageContent : InputMessageContent
{
    ...
    /// <summary>
    /// Initializes an instance of <see cref="InputLocationMessageContent"/>
    /// </summary>
    ...
    /// <summary>
    /// Instantiates a new <see cref="InputLocationMessageContent"/>
    /// </summary>
...
public partial class InputVenueMessageContent : InputMessageContent
{
    ...
    /// <summary>
    /// Initializes an instance of <see cref="InputVenueMessageContent"/>
    /// </summary>
    ...
    /// <summary>
    /// Instantiates a new <see cref="InputVenueMessageContent"/>
    /// </summary>
...
public partial class InputContactMessageContent : InputMessageContent
{
    ...
    /// <summary>
    /// Initializes an instance of <see cref="InputContactMessageContent"/>
    /// </summary>
    ...
    /// <summary>
    /// Instantiates a new <see cref="InputContactMessageContent"/>
    /// </summary>
...
public partial class InputInvoiceMessageContent : InputMessageContent
{
    ...
    /// <summary>
    /// <em>Optional</em>. A array of suggested amounts of tip in the <em>smallest units</em> of the currency (integer, <b>not</b> float/double). At most 4 suggested tip amounts can be specified. The suggested tip amounts must be positive, passed in a strictly increased order and must not exceed <see cref="MaxTipAmount">MaxTipAmount</see>.
    /// </summary>
    ...
    /// <summary>
    /// Initializes an instance of <see cref="InputInvoiceMessageContent"/>
    /// </summary>
    ...
    /// <summary>
    /// Instantiates a new <see cref="InputInvoiceMessageContent"/>
    /// </summary>
