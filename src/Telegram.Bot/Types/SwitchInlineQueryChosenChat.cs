...
public partial class SwitchInlineQueryChosenChat
{
    ...
    /// <summary>
    /// <em>Optional</em>. <see langword="true"/>, if private chats with users can be chosen
    /// </summary>
    public bool AllowUserChats { get; set; }

    /// <summary>
    /// <em>Optional</em>. <see langword="true"/>, if private chats with bots can be chosen
    /// </summary>
    public bool AllowBotChats { get; set; }

    /// <summary>
    /// <em>Optional</em>. <see langword="true"/>, if group and supergroup chats can be chosen
    /// </summary>
    public bool AllowGroupChats { get; set; }

    /// <summary>
    /// <em>Optional</em>. <see langword="true"/>, if channel chats can be chosen
    /// </summary>
