...
public partial class InlineKeyboardButton : IKeyboardButton
{
    ...
    /// <summary>
    /// <em>Optional</em>. HTTP or tg:// URL to be opened when the button is pressed. Links <c>tg://user?id=&lt;UserId&gt;</c> can be used to mention a user by their identifier without using a username, if this is allowed by their privacy settings.
    /// </summary>
    ...
    /// <summary>
    /// <em>Optional</em>. Description of the <a href="https://core.telegram.org/bots/webapps">Web App</a> that will be launched when the user presses the button. The Web App will be able to send an arbitrary message on behalf of the user using the method <see cref="WTelegram.Bot.AnswerWebAppQuery">AnswerWebAppQuery</see>. Available only in private chats between a user and the bot. Not supported for messages sent on behalf of a Telegram Business account.
    /// </summary>
    ...
    /// <summary>
    /// <em>Optional</em>. Description of the game that will be launched when the user presses the button.<br/><br/><b>NOTE:</b> This type of button <b>must</b> always be the first button in the first row.
    /// </summary>
    ...
    /// <summary>
    /// Initializes an instance of <see cref="InlineKeyboardButton"/>
    /// </summary>
    ...
    /// <summary>
    /// Instantiates a new <see cref="InlineKeyboardButton"/>
    /// </summary>
    public InlineKeyboardButton()
    { }

    /// <summary>
    /// Creates an inline keyboard button with HTTP or tg:// URL to be opened when the button is pressed. Links <c>tg://user?id=&lt;UserId&gt;</c> can be used to mention a user by their identifier without using a username, if this is allowed by their privacy settings.
    /// </summary>
    /// <param name="text">Label text on the button</param>
    ...
    /// <summary>
    /// Creates an inline keyboard button. Pressing the button will prompt the user to select one of their chats of the specified type, open that chat and insert the bot's username and the specified inline query in the input field. Not supported for messages sent on behalf of a Telegram Business account.
    /// </summary>
    /// <param name="text">Label text on the button</param>
    ...
    /// <summary>
    /// Creates an inline keyboard button with description of the game that will be launched when the user presses the button.<br/><br/><b>NOTE:</b> This type of button <b>must</b> always be the first button in the first row.
    /// </summary>
    /// <param name="text">Label text on the button</param>
