...
public partial class InlineKeyboardButton : IKeyboardButton
{
    ...
    /// <summary><em>Optional</em>. Data to be sent in a <see cref="CallbackQuery">callback query</see> to the bot when button is pressed, 1-64 bytes. Not supported for messages sent on behalf of a Telegram Business account.</summary>
    ...
    /// <summary>Creates an inline keyboard button with data to be sent in a <see cref="CallbackQuery">callback query</see> to the bot when button is pressed, 1-64 bytes. Not supported for messages sent on behalf of a Telegram Business account.</summary>
    /// <param name="text">Label text on the button</param>
