...
/// <summary>
/// This object represents one button of the reply keyboard. For simple text buttons, <em>String</em> can be used instead of this object to specify the button text. The optional fields <see cref="WebApp">WebApp</see>, <see cref="RequestUsers">RequestUsers</see>, <see cref="RequestChat">RequestChat</see>, <see cref="RequestContact">RequestContact</see>, <see cref="RequestLocation">RequestLocation</see>, and <see cref="RequestPoll">RequestPoll</see> are mutually exclusive.<br/><b>Note:</b> <see cref="RequestUsers">RequestUsers</see> and <see cref="RequestChat">RequestChat</see> options will only work in Telegram versions released after 3 February, 2023. Older clients will display <em>unsupported message</em>.
/// </summary>
public partial class KeyboardButton : IKeyboardButton
{
    ...
    /// <summary>
    /// <em>Optional.</em> If specified, pressing the button will open a list of suitable users. Identifiers of selected users will be sent to the bot in a <see cref="UsersShared"/> service message. Available in private chats only.
    /// </summary>
    public KeyboardButtonRequestUsers? RequestUsers { get; set; }

    /// <summary>
    /// <em>Optional.</em> If specified, pressing the button will open a list of suitable chats. Tapping on a chat will send its identifier to the bot in a <see cref="ChatShared"/> service message. Available in private chats only.
    /// </summary>
    public KeyboardButtonRequestChat? RequestChat { get; set; }

    /// <summary>
    /// <em>Optional</em>. If <see langword="true"/>, the user's phone number will be sent as a contact when the button is pressed. Available in private chats only.
    /// </summary>
    public bool RequestContact { get; set; }

    /// <summary>
    /// <em>Optional</em>. If <see langword="true"/>, the user's current location will be sent when the button is pressed. Available in private chats only.
    /// </summary>
    ...
    /// <summary>
    /// <em>Optional</em>. If specified, the described <a href="https://core.telegram.org/bots/webapps">Web App</a> will be launched when the button is pressed. The Web App will be able to send a <see cref="WebAppData"/> service message. Available in private chats only.
    /// </summary>
    public WebAppInfo? WebApp { get; set; }

    /// <summary>
    /// Initializes an instance of <see cref="KeyboardButton"/>
    /// </summary>
    ...
    /// <summary>
    /// Instantiates a new <see cref="KeyboardButton"/>
    /// </summary>
    public KeyboardButton()
    { }

    /// <summary>
    /// Creates a keyboard button. Pressing the button will open a list of suitable users. Identifiers of selected users will be sent to the bot in a <see cref="UsersShared"/> service message. Available in private chats only.
    /// </summary>
    ...
    /// <summary>
    /// Creates a keyboard button. The user's phone number will be sent as a contact when the button is pressed. Available in private chats only.
    /// </summary>
    /// <param name="text">Button's text</param>
    ...
    /// <summary>
    /// Creates a keyboard button. The user's current location will be sent when the button is pressed. Available in private chats only.
    /// </summary>
    /// <param name="text">Button's text</param>
    ...
    /// <summary>
    /// Creates a keyboard button. The user will be asked to create a poll and send it to the bot when the button is pressed. Available in private chats only.
    /// </summary>
    /// <param name="text">Button's text</param>
    ...
    /// <summary>
    /// Creates a keyboard button. The described <a href="https://core.telegram.org/bots/webapps">Web App</a> will be launched when the button is pressed. The Web App will be able to send a <see cref="WebAppData"/> service message. Available in private chats only.
    /// </summary>
    /// <param name="text">Button's text</param>
