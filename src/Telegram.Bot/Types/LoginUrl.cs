...
public partial class LoginUrl
{
    ...
    /// <summary>
    /// <em>Optional</em>. Pass <see langword="true"/> to request the permission for your bot to send messages to the user.
    /// </summary>
