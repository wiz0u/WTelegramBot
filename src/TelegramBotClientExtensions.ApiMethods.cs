...
public static partial class TelegramBotClientExtensions
{
    ...
    /// <summary>
    /// Use this method to receive incoming updates using long polling (<a href="https://en.wikipedia.org/wiki/Push_technology#Long_polling">wiki</a>).
    /// </summary>
    /// <remarks>
    /// <b>Notes</b><br/><b>1.</b> This method will not work if an outgoing webhook is set up.<br/><b>2.</b> In order to avoid getting duplicate updates, recalculate <see cref="Offset">Offset</see> after each server response.
    /// </remarks>
    ...
    /// <returns>
    /// An Array of <see cref="Update"/> objects.
    /// </returns>
    public static async Task<Update[]> GetUpdatesAsync(
        ...
        await botClient.Bot(cancellationToken).GetUpdates(offset ?? 0, limit ?? 100, timeout ?? 0, allowedUpdates, cancellationToken).ThrowAsApi();
    ...
    )
    {
        ...
        await botClient.DeleteWebhookAsync(dropPendingUpdates, cancellationToken);
        if (dropPendingUpdates == true)
            await botClient.GetUpdatesAsync(-1, 1, 0, allowedUpdates, cancellationToken);
        else
            try
            {
                await botClient.GetUpdatesAsync(0, 0, 0, allowedUpdates, new CancellationToken(true));
            }
            catch (TaskCanceledException) { }
    }

    /// <summary>
    /// Use this method to remove webhook integration if you decide to switch back to <see cref="WTelegram.Bot.GetUpdates">GetUpdates</see>.
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    /// <param name="dropPendingUpdates">Pass <see langword="true"/> to drop all pending updates</param>
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    ...
    )
    {
        ...
        var response = await httpClient.GetAsync($"https://api.telegram.org/bot{botClient.Token}/deleteWebhook", cancellationToken);
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// A <see cref="WebhookInfo"/> object. If the bot is using <see cref="WTelegram.Bot.GetUpdates">GetUpdates</see>, will return an object with the <em>url</em> field empty.
    /// </returns>
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// Basic information about the bot in form of a <see cref="User"/> object.
    /// </returns>
    public static async Task<User> GetMeAsync(
        this ITelegramBotClient botClient,
        CancellationToken cancellationToken = default
    ) =>
        await botClient.Bot(cancellationToken).GetMe().ThrowAsApi();
    ...
    {
        using var httpClient = new HttpClient();
        var response = await httpClient.GetAsync($"https://api.telegram.org/bot{botClient.Token}/logout", cancellationToken);
        response.EnsureSuccessStatusCode();
    }
    ...
    public static async Task CloseAsync(
        ...
        await botClient.Bot(cancellationToken).Close().ThrowAsApi();
    ...
    public static async Task<Message> SendTextMessageAsync(
        ...
        await botClient.Bot(cancellationToken).SendTextMessage(chatId, text, parseMode ?? default, replyParameters, replyMarkup, linkPreviewOptions, messageThreadId ?? 0, entities, disableNotification, protectContent, messageEffectId.LongOrDefault(), businessConnectionId).ThrowAsApi();
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// An array of <see cref="MessageId"/> of the sent messages is returned.
    /// </returns>
    ...
    /// <summary>
    /// Use this method to copy messages of any kind. Service messages, giveaway messages, giveaway winners messages, and invoice messages can't be copied. A quiz <see cref="Poll"/> can be copied only if the value of the field <em>CorrectOptionId</em> is known to the bot. The method is analogous to the method <see cref="WTelegram.Bot.ForwardMessage">ForwardMessage</see>, but the copied message doesn't have a link to the original message.
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    /// <param name="chatId">Unique identifier for the target chat or username of the target channel (in the format <c>@channelusername</c>)</param>
    /// <param name="fromChatId">Unique identifier for the chat where the original message was sent (or channel username in the format <c>@channelusername</c>)</param>
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// The <see cref="MessageId"/> of the sent message on success.
    /// </returns>
    public static async Task<MessageId> CopyMessageAsync(
        ...
        await botClient.Bot(cancellationToken).CopyMessage(chatId, fromChatId, messageId, caption, parseMode ?? default, replyParameters, replyMarkup, messageThreadId ?? 0, captionEntities, showCaptionAboveMedia, disableNotification, protectContent).ThrowAsApi();
    ...
    public static async Task<MessageId[]> CopyMessagesAsync(
        ...
        await botClient.Bot(cancellationToken).CopyMessages(chatId, fromChatId, messageIds.ToArray(), removeCaption, messageThreadId ?? 0, disableNotification, protectContent).ThrowAsApi();
    ...
    public static async Task<Message> SendPhotoAsync(
        ...
        await botClient.Bot(cancellationToken).SendPhoto(chatId, photo, caption, parseMode ?? default, replyParameters, replyMarkup, messageThreadId ?? 0, captionEntities, showCaptionAboveMedia, hasSpoiler, disableNotification, protectContent, messageEffectId.LongOrDefault(), businessConnectionId).ThrowAsApi();
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// The sent <see cref="Message"/> is returned. Bots can currently send audio files of up to 50 MB in size, this limit may be changed in the future.<br/>For sending voice messages, use the <see cref="WTelegram.Bot.SendVoice">SendVoice</see> method instead.
    /// </returns>
    public static async Task<Message> SendAudioAsync(
        ...
        await botClient.Bot(cancellationToken).SendAudio(chatId, audio, caption, parseMode ?? default, replyParameters, replyMarkup, duration ?? 0, performer, title, thumbnail, messageThreadId ?? 0, captionEntities, disableNotification, protectContent, messageEffectId.LongOrDefault(), businessConnectionId).ThrowAsApi();
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// The sent <see cref="Message"/> is returned. Bots can currently send files of any type of up to 50 MB in size, this limit may be changed in the future.
    /// </returns>
    public static async Task<Message> SendDocumentAsync(
        ...
        await botClient.Bot(cancellationToken).SendDocument(chatId, document, caption, parseMode ?? default, replyParameters, replyMarkup, thumbnail, messageThreadId ?? 0, captionEntities, disableContentTypeDetection, disableNotification, protectContent, messageEffectId.LongOrDefault(), businessConnectionId).ThrowAsApi();
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// The sent <see cref="Message"/> is returned. Bots can currently send video files of up to 50 MB in size, this limit may be changed in the future.
    /// </returns>
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// The sent <see cref="Message"/> is returned. Bots can currently send animation files of up to 50 MB in size, this limit may be changed in the future.
    /// </returns>
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// The sent <see cref="Message"/> is returned. Bots can currently send voice messages of up to 50 MB in size, this limit may be changed in the future.
    /// </returns>
    public static async Task<Message> SendVoiceAsync(
        ...
        await botClient.Bot(cancellationToken).SendVoice(chatId, voice, caption, parseMode ?? default, replyParameters, replyMarkup, duration ?? 0, messageThreadId ?? 0, captionEntities, disableNotification, protectContent, messageEffectId.LongOrDefault(), businessConnectionId).ThrowAsApi();
    ...
    public static async Task<Message> SendVideoNoteAsync(
        ...
        await botClient.Bot(cancellationToken).SendVideoNote(chatId, videoNote, replyParameters, replyMarkup, duration ?? 0, length, thumbnail, messageThreadId ?? 0, disableNotification, protectContent, messageEffectId.LongOrDefault(), businessConnectionId).ThrowAsApi();
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// An array of <see cref="Message">Messages</see> that were sent is returned.
    /// </returns>
    public static async Task<Message[]> SendMediaGroupAsync(
        ...
        await botClient.Bot(cancellationToken).SendMediaGroup(chatId, media, replyParameters, messageThreadId ?? 0, disableNotification, protectContent, messageEffectId.LongOrDefault(), businessConnectionId).ThrowAsApi();
    ...
    public static async Task<Message> SendLocationAsync(
        ...
        await botClient.Bot(cancellationToken).SendLocation(chatId, latitude, longitude, replyParameters, replyMarkup, (int)(horizontalAccuracy ?? 0), livePeriod ?? 0, heading ?? 0, proximityAlertRadius ?? 0, messageThreadId ?? 0, disableNotification, protectContent, messageEffectId.LongOrDefault(), businessConnectionId).ThrowAsApi();
    ...
    public static async Task<Message> SendVenueAsync(
        ...
        await botClient.Bot(cancellationToken).SendVenue(chatId, latitude, longitude, title, address, replyParameters, replyMarkup, foursquareId, foursquareType, googlePlaceId, googlePlaceType, messageThreadId ?? 0, disableNotification, protectContent, messageEffectId.LongOrDefault(), businessConnectionId).ThrowAsApi();
    ...
    public static async Task<Message> SendContactAsync(
        ...
        await botClient.Bot(cancellationToken).SendContact(chatId, phoneNumber, firstName, lastName, vcard, replyParameters, replyMarkup, messageThreadId ?? 0, disableNotification, protectContent, messageEffectId.LongOrDefault(), businessConnectionId).ThrowAsApi();
    ...
    public static async Task<Message> SendDiceAsync(
        ...
        await botClient.Bot(cancellationToken).SendDice(chatId, emoji ?? Emoji.Dice, replyParameters, replyMarkup, messageThreadId ?? 0, disableNotification, protectContent, messageEffectId.LongOrDefault(), businessConnectionId).ThrowAsApi();
    ...
    public static async Task SendChatActionAsync(
        ...
        await botClient.Bot(cancellationToken).SendChatAction(chatId, action, messageThreadId ?? 0, businessConnectionId).ThrowAsApi();
    ...
    public static async Task SetMessageReactionAsync(
        ...
        await botClient.Bot(cancellationToken).SetMessageReaction(chatId, messageId, reaction, isBig).ThrowAsApi();
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// A <see cref="UserProfilePhotos"/> object.
    /// </returns>
    public static async Task<UserProfilePhotos> GetUserProfilePhotosAsync(
        ...
        await botClient.Bot(cancellationToken).GetUserProfilePhotos(userId, offset ?? 0, limit ?? 100).ThrowAsApi();
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// A <see cref="File"/> object is returned. The file can then be downloaded via <see cref="WTelegram.Bot.DownloadFile"/>, where <c>&lt;FilePath&gt;</c> is taken from the response. It is guaranteed that the link will be valid for at least 1 hour. When the link expires, a new one can be requested by calling <see cref="WTelegram.Bot.GetFile">GetFile</see> again.<br/><b>Note:</b> This function may not preserve the original file name and MIME type. You should save the file's MIME type and name (if available) when the File object is received.
    /// </returns>
    public static async Task<File> GetFileAsync(
        ...
        await botClient.Bot(cancellationToken).GetFile(fileId).ThrowAsApi();

    /// <summary>
    /// Use this method to ban a user in a group, a supergroup or a channel. In the case of supergroups and channels, the user will not be able to return to the chat on their own using invite links, etc., unless <see cref="WTelegram.Bot.UnbanChatMember">unbanned</see> first. The bot must be an administrator in the chat for this to work and must have the appropriate administrator rights.
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    ...
    public static async Task UnbanChatMemberAsync(
        ...
        await botClient.Bot(cancellationToken).UnbanChatMember(chatId, userId, onlyIfBanned).ThrowAsApi();

    /// <summary>
    /// Use this method to restrict a user in a supergroup. The bot must be an administrator in the supergroup for this to work and must have the appropriate administrator rights. Pass <em>True</em> for all permissions to lift restrictions from a user.
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    ...
    /// <summary>
    /// Use this method to promote or demote a user in a supergroup or a channel. The bot must be an administrator in the chat for this to work and must have the appropriate administrator rights. Pass <em>False</em> for all boolean parameters to demote a user.
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    /// <param name="chatId">Unique identifier for the target chat or username of the target channel (in the format <c>@channelusername</c>)</param>
    /// <param name="userId">Unique identifier of the target user</param>
    ...
    public static async Task SetChatAdministratorCustomTitleAsync(
        ...
        await botClient.Bot(cancellationToken).SetChatAdministratorCustomTitle(chatId, userId, customTitle).ThrowAsApi();

    /// <summary>
    /// Use this method to ban a channel chat in a supergroup or a channel. Until the chat is <see cref="WTelegram.Bot.UnbanChatSenderChat">unbanned</see>, the owner of the banned chat won't be able to send messages on behalf of <b>any of their channels</b>. The bot must be an administrator in the supergroup or channel for this to work and must have the appropriate administrator rights.
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    /// <param name="chatId">Unique identifier for the target chat or username of the target channel (in the format <c>@channelusername</c>)</param>
    ...
    /// <summary>
    /// Use this method to set default chat permissions for all members. The bot must be an administrator in the group or a supergroup for this to work and must have the <em>CanRestrictMembers</em> administrator rights.
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    /// <param name="chatId">Unique identifier for the target chat or username of the target supergroup (in the format <c>@supergroupusername</c>)</param>
    ...
    /// </summary>
    /// <remarks>
    /// Note: Each administrator in a chat generates their own invite links. Bots can't use invite links generated by other administrators. If you want your bot to work with invite links, it will need to generate its own link using <see cref="WTelegram.Bot.ExportChatInviteLink">ExportChatInviteLink</see> or by calling the <see cref="WTelegram.Bot.GetChat">GetChat</see> method. If your bot needs to generate a new primary invite link replacing its previous one, use <see cref="WTelegram.Bot.ExportChatInviteLink">ExportChatInviteLink</see> again.
    /// </remarks>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    /// <param name="chatId">Unique identifier for the target chat or username of the target channel (in the format <c>@channelusername</c>)</param>
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    ...
    public static async Task<string> ExportChatInviteLinkAsync(
        ...
        await botClient.Bot(cancellationToken).ExportChatInviteLink(chatId).ThrowAsApi();

    /// <summary>
    /// Use this method to create an additional invite link for a chat. The bot must be an administrator in the chat for this to work and must have the appropriate administrator rights. The link can be revoked using the method <see cref="WTelegram.Bot.RevokeChatInviteLink">RevokeChatInviteLink</see>.
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    /// <param name="chatId">Unique identifier for the target chat or username of the target channel (in the format <c>@channelusername</c>)</param>
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// The new invite link as <see cref="ChatInviteLink"/> object.
    /// </returns>
    public static async Task<ChatInviteLink> CreateChatInviteLinkAsync(
        ...
        await botClient.Bot(cancellationToken).CreateChatInviteLink(chatId, name, expireDate, memberLimit, createsJoinRequest).ThrowAsApi();
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// The edited invite link as a <see cref="ChatInviteLink"/> object.
    /// </returns>
    public static async Task<ChatInviteLink> EditChatInviteLinkAsync(
        ...
        await botClient.Bot(cancellationToken).EditChatInviteLink(chatId, inviteLink, name, expireDate, memberLimit, createsJoinRequest).ThrowAsApi();
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// The revoked invite link as <see cref="ChatInviteLink"/> object.
    /// </returns>
    public static async Task<ChatInviteLink> RevokeChatInviteLinkAsync(
        ...
        await botClient.Bot(cancellationToken).RevokeChatInviteLink(chatId, inviteLink).ThrowAsApi();

    /// <summary>
    /// Use this method to approve a chat join request. The bot must be an administrator in the chat for this to work and must have the <em>CanInviteUsers</em> administrator right.
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    /// <param name="chatId">Unique identifier for the target chat or username of the target channel (in the format <c>@channelusername</c>)</param>
    /// <param name="userId">Unique identifier of the target user</param>
    ...
    public static async Task<bool> ApproveChatJoinRequest(
        ...
        await botClient.Bot(cancellationToken).HideChatJoinRequest(chatId, userId, true).ThrowAsApi();

    /// <summary>
    /// Use this method to decline a chat join request. The bot must be an administrator in the chat for this to work and must have the <em>CanInviteUsers</em> administrator right.
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    /// <param name="chatId">Unique identifier for the target chat or username of the target channel (in the format <c>@channelusername</c>)</param>
    /// <param name="userId">Unique identifier of the target user</param>
    ...
    public static async Task<bool> DeclineChatJoinRequest(
        ...
        await botClient.Bot(cancellationToken).HideChatJoinRequest(chatId, userId, false).ThrowAsApi();
    ...
    public static async Task SetChatPhotoAsync(
        ...
        await botClient.Bot(cancellationToken).SetChatPhoto(chatId, photo).ThrowAsApi();
    ...
    public static async Task SetChatTitleAsync(
        ...
        await botClient.Bot(cancellationToken).SetChatTitle(chatId, title).ThrowAsApi();
    ...
    public static async Task SetChatDescriptionAsync(
        ...
        await botClient.Bot(cancellationToken).SetChatDescription(chatId, description).ThrowAsApi();
    ...
    public static async Task UnpinChatMessageAsync(
        ...
        await botClient.Bot(cancellationToken).PinUnpinChatMessage(chatId, messageId ?? default, false).ThrowAsApi();
    ...
    public static async Task LeaveChatAsync(
        ...
        await botClient.Bot(cancellationToken).LeaveChat(chatId).ThrowAsApi();
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// A <see cref="ChatFullInfo"/> object on success.
    /// </returns>
    public static async Task<ChatFullInfo> GetChatAsync(
        ...
        await botClient.Bot(cancellationToken).GetChat(chatId).ThrowAsApi();
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// An Array of <see cref="ChatMember"/> objects.
    /// </returns>
    public static async Task<ChatMember[]> GetChatAdministratorsAsync(
        ...
        await botClient.Bot(cancellationToken).GetChatAdministrators(chatId).ThrowAsApi();
    ...
    public static async Task<int> GetChatMemberCountAsync(
        ...
        await botClient.Bot(cancellationToken).GetChatMemberCount(chatId).ThrowAsApi();
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// A <see cref="ChatMember"/> object on success.
    /// </returns>
    public static async Task<ChatMember> GetChatMemberAsync(
        ...
        await botClient.Bot(cancellationToken).GetChatMember(chatId, userId).ThrowAsApi();

    /// <summary>
    /// Use this method to set a new group sticker set for a supergroup. The bot must be an administrator in the chat for this to work and must have the appropriate administrator rights. Use the field <em>CanSetStickerSet</em> optionally returned in <see cref="WTelegram.Bot.GetChat">GetChat</see> requests to check if the bot can use this method.
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    /// <param name="chatId">Unique identifier for the target chat or username of the target supergroup (in the format <c>@supergroupusername</c>)</param>
    ...
    public static async Task SetChatStickerSetAsync(
        ...
        await botClient.Bot(cancellationToken).SetChatStickerSet(chatId, stickerSetName).ThrowAsApi();
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// An Array of <see cref="Sticker"/> objects.
    /// </returns>
    public static async Task<Sticker[]> GetForumTopicIconStickersAsync(
        this ITelegramBotClient botClient,
        CancellationToken cancellationToken = default
    ) =>
        await botClient.Bot(cancellationToken).GetForumTopicIconStickers().ThrowAsApi();

    /// <summary>
    /// Use this method to create a topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the <em>CanManageTopics</em> administrator rights.
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    /// <param name="chatId">Unique identifier for the target chat or username of the target supergroup (in the format <c>@supergroupusername</c>)</param>
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// Information about the created topic as a <see cref="ForumTopic"/> object.
    /// </returns>
    public static async Task<ForumTopic> CreateForumTopicAsync(
        ...
        await botClient.Bot(cancellationToken).CreateForumTopic(chatId, name, iconColor, iconCustomEmojiId).ThrowAsApi();

    /// <summary>
    /// Use this method to edit name and icon of a topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have <em>CanManageTopics</em> administrator rights, unless it is the creator of the topic.
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    /// <param name="chatId">Unique identifier for the target chat or username of the target supergroup (in the format <c>@supergroupusername</c>)</param>
    ...
    public static async Task EditForumTopicAsync(
        ...
        await botClient.Bot(cancellationToken).EditForumTopic(chatId, messageThreadId, name, iconCustomEmojiId).ThrowAsApi();

    /// <summary>
    /// Use this method to close an open topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the <em>CanManageTopics</em> administrator rights, unless it is the creator of the topic.
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    /// <param name="chatId">Unique identifier for the target chat or username of the target supergroup (in the format <c>@supergroupusername</c>)</param>
    /// <param name="messageThreadId">Unique identifier for the target message thread of the forum topic</param>
    ...
    /// <summary>
    /// Use this method to reopen a closed topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the <em>CanManageTopics</em> administrator rights, unless it is the creator of the topic.
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    /// <param name="chatId">Unique identifier for the target chat or username of the target supergroup (in the format <c>@supergroupusername</c>)</param>
    /// <param name="messageThreadId">Unique identifier for the target message thread of the forum topic</param>
    ...
    /// <summary>
    /// Use this method to delete a forum topic along with all its messages in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the <em>CanDeleteMessages</em> administrator rights.
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    /// <param name="chatId">Unique identifier for the target chat or username of the target supergroup (in the format <c>@supergroupusername</c>)</param>
    /// <param name="messageThreadId">Unique identifier for the target message thread of the forum topic</param>
    ...
    public static async Task DeleteForumTopicAsync(
        ...
        await botClient.Bot(cancellationToken).DeleteForumTopic(chatId, messageThreadId).ThrowAsApi();

    /// <summary>
    /// Use this method to clear the list of pinned messages in a forum topic. The bot must be an administrator in the chat for this to work and must have the <em>CanPinMessages</em> administrator right in the supergroup.
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    /// <param name="chatId">Unique identifier for the target chat or username of the target supergroup (in the format <c>@supergroupusername</c>)</param>
    /// <param name="messageThreadId">Unique identifier for the target message thread of the forum topic</param>
    ...
    /// <summary>
    /// Use this method to edit the name of the 'General' topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have <em>CanManageTopics</em> administrator rights.
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    /// <param name="chatId">Unique identifier for the target chat or username of the target supergroup (in the format <c>@supergroupusername</c>)</param>
    ...
    public static async Task EditGeneralForumTopicAsync(
        ...
        await botClient.Bot(cancellationToken).EditForumTopic(chatId, 1, name).ThrowAsApi();

    /// <summary>
    /// Use this method to close an open 'General' topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the <em>CanManageTopics</em> administrator rights.
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    /// <param name="chatId">Unique identifier for the target chat or username of the target supergroup (in the format <c>@supergroupusername</c>)</param>
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    ...
    /// <summary>
    /// Use this method to reopen a closed 'General' topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the <em>CanManageTopics</em> administrator rights. The topic will be automatically unhidden if it was hidden.
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    /// <param name="chatId">Unique identifier for the target chat or username of the target supergroup (in the format <c>@supergroupusername</c>)</param>
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    ...
    /// <summary>
    /// Use this method to hide the 'General' topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the <em>CanManageTopics</em> administrator rights. The topic will be automatically closed if it was open.
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    /// <param name="chatId">Unique identifier for the target chat or username of the target supergroup (in the format <c>@supergroupusername</c>)</param>
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    public static async Task HideGeneralForumTopicAsync(
        ...
        await botClient.Bot(cancellationToken).HideGeneralForumTopic(chatId).ThrowAsApi();

    /// <summary>
    /// Use this method to unhide the 'General' topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the <em>CanManageTopics</em> administrator rights.
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    /// <param name="chatId">Unique identifier for the target chat or username of the target supergroup (in the format <c>@supergroupusername</c>)</param>
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    public static async Task UnhideGeneralForumTopicAsync(
        ...
        await botClient.Bot(cancellationToken).HideGeneralForumTopic(chatId, false).ThrowAsApi();

    /// <summary>
    /// Use this method to clear the list of pinned messages in a General forum topic. The bot must be an administrator in the chat for this to work and must have the <em>CanPinMessages</em> administrator right in the supergroup.
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    /// <param name="chatId">Unique identifier for the target chat or username of the target supergroup (in the format <c>@supergroupusername</c>)</param>
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    ...
    /// <summary>
    /// Use this method to send answers to callback queries sent from <a href="https://core.telegram.org/bots/features#inline-keyboards">inline keyboards</a>. The answer will be displayed to the user as a notification at the top of the chat screen or as an alert
    /// </summary>
    /// <remarks>
    ...
    public static async Task AnswerCallbackQueryAsync(
        ...
        await botClient.Bot(cancellationToken).AnswerCallbackQuery(callbackQueryId, text, showAlert, url, cacheTime ?? 0).ThrowAsApi();
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// A <see cref="UserChatBoosts"/> object.
    /// </returns>
    public static async Task<UserChatBoosts> GetUserChatBoostsAsync(
        ...
        await botClient.Bot(cancellationToken).GetUserChatBoosts(chatId, userId).ThrowAsApi();
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// A <see cref="BusinessConnection"/> object on success.
    /// </returns>
    public static async Task<BusinessConnection> GetBusinessConnectionAsync(
        ...
        await botClient.Bot(cancellationToken).GetBusinessConnection(businessConnectionId).ThrowAsApi();

    /// <summary>
    /// Use this method to change the list of the bot's commands. See <a href="https://core.telegram.org/bots/features#commands">this manual</a> for more details about bot commands.
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    ...
    public static async Task SetMyCommandsAsync(
        ...
        await botClient.Bot(cancellationToken).SetMyCommands(commands, scope, languageCode).ThrowAsApi();

    /// <summary>
    /// Use this method to delete the list of the bot's commands for the given scope and user language. After deletion, <a href="https://core.telegram.org/bots/api#determining-list-of-commands">higher level commands</a> will be shown to affected users.
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    /// <param name="scope">An object, describing scope of users for which the commands are relevant. Defaults to <see cref="BotCommandScopeDefault"/>.</param>
    /// <param name="languageCode">A two-letter ISO 639-1 language code. If empty, commands will be applied to all users from the given scope, for whose language there are no dedicated commands</param>
    ...
    public static async Task DeleteMyCommandsAsync(
        ...
        await botClient.Bot(cancellationToken).DeleteMyCommands(scope, languageCode).ThrowAsApi();
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// An Array of <see cref="BotCommand"/> objects. If commands aren't set, an empty list is returned.
    /// </returns>
    public static async Task<BotCommand[]> GetMyCommandsAsync(
        ...
        await botClient.Bot(cancellationToken).GetMyCommands(scope, languageCode).ThrowAsApi();
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// <see cref="BotDescription"/> on success.
    /// </returns>
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// <see cref="BotShortDescription"/> on success.
    /// </returns>
    ...
    public static async Task SetChatMenuButtonAsync(
        ...
        await botClient.Bot(cancellationToken).SetChatMenuButton(chatId, menuButton).ThrowAsApi();
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// <see cref="MenuButton"/> on success.
    /// </returns>
    public static async Task<MenuButton> GetChatMenuButtonAsync(
        ...
        await botClient.Bot(cancellationToken).GetChatMenuButton(chatId).ThrowAsApi();
    ...
    public static async Task SetMyDefaultAdministratorRightsAsync(
        ...
        await botClient.Bot(cancellationToken).SetMyDefaultAdministratorRights(rights, forChannels).ThrowAsApi();
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// <see cref="ChatAdministratorRights"/> on success.
    /// </returns>
    public static async Task<ChatAdministratorRights> GetMyDefaultAdministratorRightsAsync(
        ...
        await botClient.Bot(cancellationToken).GetMyDefaultAdministratorRights(forChannels).ThrowAsApi();
    ...
    public static async Task<Message> EditMessageCaptionAsync(
        ...
        await botClient.Bot(cancellationToken).EditMessageCaption(chatId, messageId, caption, parseMode ?? default, captionEntities, showCaptionAboveMedia, replyMarkup).ThrowAsApi();
    ...
    public static async Task EditMessageCaptionAsync(
        ...
        await botClient.Bot(cancellationToken).EditMessageCaption(inlineMessageId, caption, parseMode ?? default, captionEntities, showCaptionAboveMedia, replyMarkup).ThrowAsApi();
    ...
    public static async Task<Message> EditMessageMediaAsync(
        ...
        await botClient.Bot(cancellationToken).EditMessageMedia(chatId, messageId, media, replyMarkup).ThrowAsApi();
    ...
    public static async Task EditMessageMediaAsync(
        ...
        await botClient.Bot(cancellationToken).EditMessageMedia(inlineMessageId, media, replyMarkup).ThrowAsApi();

    /// <summary>
    /// Use this method to edit live location messages. A location can be edited until its <see cref="LivePeriod">LivePeriod</see> expires or editing is explicitly disabled by a call to <see cref="WTelegram.Bot.StopMessageLiveLocation">StopMessageLiveLocation</see>.
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    /// <param name="chatId">Unique identifier for the target chat or username of the target channel (in the format <c>@channelusername</c>)</param>
    /// <param name="messageId">Identifier of the message to edit</param>
    ...
    public static async Task<Message> EditMessageLiveLocationAsync(
        ...
        await botClient.Bot(cancellationToken).EditMessageLiveLocation(chatId, messageId, latitude, longitude, livePeriod ?? 0, (int)(horizontalAccuracy ?? 0), heading ?? 0, proximityAlertRadius ?? 0, replyMarkup).ThrowAsApi();
    ...
    public static async Task EditMessageLiveLocationAsync(
        ...
        await botClient.Bot(cancellationToken).EditMessageLiveLocation(inlineMessageId, latitude, longitude, livePeriod ?? 0, (int)(horizontalAccuracy ?? 0), heading ?? 0, proximityAlertRadius ?? 0, replyMarkup).ThrowAsApi();

    /// <summary>
    /// Use this method to stop updating a live location message before <em>LivePeriod</em> expires.
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    /// <param name="chatId">Unique identifier for the target chat or username of the target channel (in the format <c>@channelusername</c>)</param>
    ...
    public static async Task<Message> StopMessageLiveLocationAsync(
        ...
        await botClient.Bot(cancellationToken).StopMessageLiveLocation(chatId, messageId, replyMarkup).ThrowAsApi();
    ...
    public static async Task StopMessageLiveLocationAsync(
        ...
        await botClient.Bot(cancellationToken).StopMessageLiveLocation(inlineMessageId, replyMarkup).ThrowAsApi();
    ...
    public static async Task<Message> EditMessageReplyMarkupAsync(
        ...
        await botClient.Bot(cancellationToken).EditMessageReplyMarkup(chatId, messageId, replyMarkup).ThrowAsApi();
    ...
    public static async Task EditMessageReplyMarkupAsync(
        ...
        await botClient.Bot(cancellationToken).EditMessageReplyMarkup(inlineMessageId, replyMarkup).ThrowAsApi();
    ...
    public static async Task<Poll> StopPollAsync(
        ...
        await botClient.Bot(cancellationToken).StopPoll(chatId, messageId, replyMarkup).ThrowAsApi();
    ...
    public static async Task<Message> SendStickerAsync(
        ...
        await botClient.Bot(cancellationToken).SendSticker(chatId, sticker, replyParameters, replyMarkup, emoji, messageThreadId ?? 0, disableNotification, protectContent, messageEffectId.LongOrDefault(), businessConnectionId).ThrowAsApi();
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// A <see cref="StickerSet"/> object is returned.
    /// </returns>
    public static async Task<StickerSet> GetStickerSetAsync(
        ...
        await botClient.Bot(cancellationToken).GetStickerSet(name).ThrowAsApi();
    ...
    public static async Task<Sticker[]> GetCustomEmojiStickersAsync(
        ...
        await botClient.Bot(cancellationToken).GetCustomEmojiStickers(customEmojiIds).ThrowAsApi();

    /// <summary>
    /// Use this method to upload a file with a sticker for later use in the <see cref="WTelegram.Bot.CreateNewStickerSet">CreateNewStickerSet</see>, <see cref="WTelegram.Bot.AddStickerToSet">AddStickerToSet</see>, or <see cref="WTelegram.Bot.ReplaceStickerInSet">ReplaceStickerInSet</see> methods (the file can be used multiple times).
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// The uploaded <see cref="File"/> on success.
    /// </returns>
    public static async Task<File> UploadStickerFileAsync(
        ...
        await botClient.Bot(cancellationToken).UploadStickerFile(userId, sticker, stickerFormat).ThrowAsApi();
    ...
    public static async Task CreateNewStickerSetAsync(
        ...
        await botClient.Bot(cancellationToken).CreateNewStickerSet(userId, name, title, stickers, stickerType, needsRepainting).ThrowAsApi();
    ...
    public static async Task AddStickerToSetAsync(
        ...
        await botClient.Bot(cancellationToken).AddStickerToSet(userId, name, sticker).ThrowAsApi();
    ...
    public static async Task SetStickerPositionInSetAsync(
        ...
        await botClient.Bot(cancellationToken).SetStickerPositionInSet(sticker, position).ThrowAsApi();
    ...
    public static async Task DeleteStickerFromSetAsync(
        ...
        await botClient.Bot(cancellationToken).DeleteStickerFromSet(sticker).ThrowAsApi();

    /// <summary>
    /// Use this method to replace an existing sticker in a sticker set with a new one. The method is equivalent to calling <see cref="WTelegram.Bot.DeleteStickerFromSet">DeleteStickerFromSet</see>, then <see cref="WTelegram.Bot.AddStickerToSet">AddStickerToSet</see>, then <see cref="WTelegram.Bot.SetStickerPositionInSet">SetStickerPositionInSet</see>.
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    ...
    public static async Task ReplaceStickerInSetAsync(
        ...
        await botClient.Bot(cancellationToken).ReplaceStickerInSet(userId, name, oldSticker, sticker).ThrowAsApi();
    ...
    /// <summary>
    /// Use this method to change the <see cref="MaskPosition">mask position</see> of a mask sticker. The sticker must belong to a sticker set that was created by the bot.
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    /// <param name="sticker">File identifier of the sticker</param>
    ...
    public static async Task SetStickerSetTitleAsync(
        ...
        await botClient.Bot(cancellationToken).SetStickerSetTitle(name, title).ThrowAsApi();
    ...
    public static async Task SetStickerSetThumbnailAsync(
        ...
        await botClient.Bot(cancellationToken).SetStickerSetThumbnail(name, userId, format, thumbnail).ThrowAsApi();
    ...
    public static async Task SetCustomEmojiStickerSetThumbnailAsync(
        ...
        await botClient.Bot(cancellationToken).SetCustomEmojiStickerSetThumbnail(name, customEmojiId).ThrowAsApi();
    ...
    public static async Task DeleteStickerSetAsync(
        ...
        await botClient.Bot(cancellationToken).DeleteStickerSet(name).ThrowAsApi();
    ...
    /// <summary>
    /// Use this method to send answers to an inline query<br/>No more than <b>50</b> results per query are allowed.
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    ...
    public static async Task AnswerInlineQueryAsync(
        ...
        await botClient.Bot(cancellationToken).AnswerInlineQuery(inlineQueryId, results, cacheTime ?? 300, isPersonal, nextOffset, button).ThrowAsApi();

    /// <summary>
    /// Use this method to set the result of an interaction with a <a href="https://core.telegram.org/bots/webapps">Web App</a> and send a corresponding message on behalf of the user to the chat from which the query originated.
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// A <see cref="SentWebAppMessage"/> object is returned.
    /// </returns>
    ...
    {
        var sent = await botClient.Bot(cancellationToken).AnswerWebAppQuery(webAppQueryId, result).ThrowAsApi();
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// The created invoice link as <em>String</em> on success.
    /// </returns>
    ...
    /// <summary>
    /// If you sent an invoice requesting a shipping address and the parameter <em>IsFlexible</em> was specified, the Bot API will send an <see cref="Update"/> with a <em>ShippingQuery</em> field to the bot. Use this method to reply to shipping queries
    /// </summary>
    /// <param name="botClient">An instance of <see cref="ITelegramBotClient"/></param>
    ...
    public static async Task AnswerShippingQueryAsync(
        ...
        await botClient.Bot(cancellationToken).AnswerShippingQuery(shippingQueryId, null, shippingOptions).ThrowAsApi();
    ...
    public static async Task AnswerPreCheckoutQueryAsync(
        ...
        await botClient.Bot(cancellationToken).AnswerPreCheckoutQuery(preCheckoutQueryId).ThrowAsApi();
    ...
    public static async Task AnswerPreCheckoutQueryAsync(
        ...
        await botClient.Bot(cancellationToken).AnswerPreCheckoutQuery(preCheckoutQueryId, errorMessage).ThrowAsApi();
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    public static Task RefundStarPayment(
        this ITelegramBotClient botClient,
        long userId,
    ...
    public static async Task<Message> SendGameAsync(
        ...
        await botClient.Bot(cancellationToken).SendGame(chatId, gameShortName, replyParameters, replyMarkup, messageThreadId ?? 0, disableNotification, protectContent, messageEffectId.LongOrDefault(), businessConnectionId).ThrowAsApi();
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// The <see cref="Message"/> is returned
    /// </returns>
    public static async Task<Message> SetGameScoreAsync(
        ...
        await botClient.Bot(cancellationToken).SetGameScore(userId, score, chatId, messageId, force, disableEditMessage).ThrowAsApi();
    ...
    public static async Task SetGameScoreAsync(
        ...
        await botClient.Bot(cancellationToken).SetGameScore(userId, score, inlineMessageId, force, disableEditMessage).ThrowAsApi();
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation</param>
    /// <returns>
    /// An Array of <see cref="GameHighScore"/> objects.
    /// </returns>
    public static async Task<GameHighScore[]> GetGameHighScoresAsync(
        ...
        await botClient.Bot(cancellationToken).GetGameHighScores(userId, chatId, messageId).ThrowAsApi();
    ...
    public static async Task<GameHighScore[]> GetGameHighScoresAsync(
        ...
        await botClient.Bot(cancellationToken).GetGameHighScores(userId, inlineMessageId).ThrowAsApi();

    #endregion Games

    static WTelegram.Bot Bot(this ITelegramBotClient botClient, CancellationToken cancellationToken)
    {
        cancellationToken.ThrowIfCancellationRequested();
        return botClient.Bot;
    }

    static async Task<T> ThrowAsApi<T>(this Task<T> task)
    {
        try
        {
        ...
        {
            throw TelegramBotClient.MakeException(ex);
        }
    }
    static async Task ThrowAsApi(this Task task)
    {
        try
        {
