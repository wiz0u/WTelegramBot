...
public partial class WTelegramBotClient
{
    ...
    public async Task PinChatMessageAsync(
        ...
        await ThrowIfCancelled(cancellationToken).PinUnpinChatMessage(chatId, messageId, true, disableNotification).ThrowAsApi();
    ...
    public async Task UnpinChatMessageAsync(
        ...
        await ThrowIfCancelled(cancellationToken).PinUnpinChatMessage(chatId, messageId ?? default, false).ThrowAsApi();
