...
public static partial class TelegramBotClientExtensions
{
    ...
    public static async Task<Message> SendTextMessageAsync(
        ...
        await botClient.Bot(cancellationToken).SendTextMessage(chatId, text, parseMode, replyParameters, replyMarkup, linkPreviewOptions, messageThreadId ?? 0, entities, disableNotification, protectContent, messageEffectId.LongOrDefault(), businessConnectionId).ThrowAsApi();
    ...
    public static async Task<MessageId> CopyMessageAsync(
        ...
        await botClient.Bot(cancellationToken).CopyMessage(chatId, fromChatId, messageId, caption, parseMode, replyParameters, replyMarkup, messageThreadId ?? 0, captionEntities, showCaptionAboveMedia, disableNotification, protectContent).ThrowAsApi();
    ...
    public static async Task<Message> SendPhotoAsync(
        ...
        await botClient.Bot(cancellationToken).SendPhoto(chatId, photo, caption, parseMode, replyParameters, replyMarkup, messageThreadId ?? 0, captionEntities, showCaptionAboveMedia, hasSpoiler, disableNotification, protectContent, messageEffectId.LongOrDefault(), businessConnectionId).ThrowAsApi();
    ...
    public static async Task<Message> SendAudioAsync(
        ...
        await botClient.Bot(cancellationToken).SendAudio(chatId, audio, caption, parseMode, replyParameters, replyMarkup, duration ?? 0, performer, title, thumbnail, messageThreadId ?? 0, captionEntities, disableNotification, protectContent, messageEffectId.LongOrDefault(), businessConnectionId).ThrowAsApi();
    ...
    public static async Task<Message> SendDocumentAsync(
        ...
        await botClient.Bot(cancellationToken).SendDocument(chatId, document, caption, parseMode, replyParameters, replyMarkup, thumbnail, messageThreadId ?? 0, captionEntities, disableContentTypeDetection, disableNotification, protectContent, messageEffectId.LongOrDefault(), businessConnectionId).ThrowAsApi();
    ...
    public static async Task<Message> SendVoiceAsync(
        ...
        await botClient.Bot(cancellationToken).SendVoice(chatId, voice, caption, parseMode, replyParameters, replyMarkup, duration ?? 0, messageThreadId ?? 0, captionEntities, disableNotification, protectContent, messageEffectId.LongOrDefault(), businessConnectionId).ThrowAsApi();
    ...
    public static async Task<Message> EditMessageCaptionAsync(
        ...
        await botClient.Bot(cancellationToken).EditMessageCaption(chatId, messageId, caption, parseMode, captionEntities, showCaptionAboveMedia, replyMarkup).ThrowAsApi();
    ...
    public static async Task EditMessageCaptionAsync(
        ...
        await botClient.Bot(cancellationToken).EditMessageCaption(inlineMessageId, caption, parseMode, captionEntities, showCaptionAboveMedia, replyMarkup).ThrowAsApi();
    ...
    public static async Task RefundStarPayment(
        ...
        await botClient.Bot(cancellationToken).RefundStarPayment(userId, telegramPaymentChargeId).ThrowAsApi();
    ...
    public static async Task SetPassportDataErrors(
        ...
        CancellationToken cancellationToken = default
    ) => await botClient.Bot(cancellationToken).SetPassportDataErrors(userId, errors).ThrowAsApi();
