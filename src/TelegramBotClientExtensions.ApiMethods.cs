...
public static partial class TelegramBotClientExtensions
{
    ...
    public static async Task<UserProfilePhotos> GetUserProfilePhotosAsync(
        ...
        await botClient.Bot(cancellationToken).GetUserProfilePhotos(userId, offset, limit).ThrowAsApi();
    ...
    public static async Task HideGeneralForumTopicAsync(
        ...
        await botClient.Bot(cancellationToken).HideGeneralForumTopic(chatId, true).ThrowAsApi();
    ...
    public static async Task AnswerWebAppQueryAsync(
        ...
        await botClient.Bot(cancellationToken).AnswerWebAppQuery(webAppQueryId, result).ThrowAsApi();
